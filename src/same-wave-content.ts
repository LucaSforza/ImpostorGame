...
export const SAME_WAVE_PROMPTS: readonly SameWavePrompt[] = [
  { id: "wave-01", prompt: "La colazione perfetta?", promptEn: "The perfect breakfast?", options: ["Cornetto e cappuccino", "Pane, burro e marmellata", "Uova e toast", "Yogurt e frutta"], optionsEn: ["Croissant and cappuccino", "Bread, butter, and jam", "Eggs and toast", "Yogurt and fruit"] },
  ...
  { id: "wave-05", prompt: "Quale pizza ordini?", promptEn: "Which pizza would you order?", options: ["Margherita", "Quattro formaggi", "Diavola", "Verdure grigliate"], optionsEn: ["Margherita", "Four cheeses", "Spicy salami", "Grilled vegetables"] },
  ...
  { id: "wave-13", prompt: "Cosa ascolti in viaggio?", promptEn: "What do you listen to on a trip?", options: ["Pop", "Rock", "Classica", "Podcast"], optionsEn: ["Pop", "Rock", "Classical", "Podcast"] },
  ...
  { id: "wave-21", prompt: "Fuori piove: cosa fai?", promptEn: "It's raining outside: what do you do?", options: ["Guardo un film", "Preparo un tè", "Salto nelle pozzanghere", "Leggo un libro"], optionsEn: ["Watch a movie", "Make some tea", "Jump in puddles", "Read a book"] },
  ...
  { id: "wave-43", prompt: "Dove ti piace chiacchierare?", promptEn: "Where do you like to chat?", options: ["Cucina", "Panchina", "Caffè", "Al parco"], optionsEn: ["Kitchen", "Bench", "Café", "In the park"] },
  ...
  { id: "wave-45", prompt: "Il tuo modo di scegliere un film?", promptEn: "How do you choose a movie?", options: ["Trailer", "Consiglio", "Genere", "Titolo intrigante"], optionsEn: ["Trailer", "Recommendation", "Genre", "Intriguing title"] },
  ...
  { id: "wave-50", prompt: "In gruppo, quale ruolo ti viene naturale?", promptEn: "What role comes naturally to you in a group?", options: ["Chi ascolta", "Chi fa ridere", "Chi propone idee", "Chi organizza"], optionsEn: ["The listener", "The one who makes people laugh", "The idea person", "The organizer"] },
